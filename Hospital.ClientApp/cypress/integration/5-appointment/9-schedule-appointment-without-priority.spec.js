...
context('Schedule appointment without priority', () => {
    ...
    it('should filter appointemnts fail', () => {
        cy.get('[data-cy=schedule-appointment-btn]').click()
        cy.get('[data-cy=schedule-startDate-input]').type("2021-08-12")
    ...
    it('should filter appointemnts containing appointment for 12.Jul', () => {
        ...
        cy.get('body').contains("12. Jul 2021.")
    })
    ...
    it('should confirm that appointment is created ', () => {
        ...
        console.log("scheduledAppointmentStartDate", scheduledAppointmentStartDate)
